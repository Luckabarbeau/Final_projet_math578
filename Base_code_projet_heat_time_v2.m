...
D_Solution=Runge_kutta_dudt(Solution,t,dt,A_global);
Solution(1:length(mesh.points))=Solution(1:length(mesh.points))+D_Solution(1:length(mesh.points));
D_Solution_S=A_global*Solution;
RHS=[D_Solution_S(1:length(mesh.points));B];
Solution=A_global\RHS;
